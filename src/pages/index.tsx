...
export default function Home() {
    ...
    return (
        <div className="background-image">
            <Navbar />
            <Container
                className="flex flex-col items-center mt-14 pb-10 rounded-2xl bg-opacity-90 bg-white max-md:w-11/12">
                    <>
                        <Image className="mt-10 w-40 h-40 rounded-full mb-6" src={walletLogo} alt="wallet" />
                        <Typography
                            variant="h4"
                            component="h1"
                            align="center"
                            ...
                            gutterBottom
                        >
                           Revolutionize your finances with <span className="text-sky-800">Next Wallet</span>
                        </Typography>
                        <Typography variant="body1" component="p" color="text.secondary" className="mb-4 max-md:text-sm">
                        ...
                        <Box display="flex" className="flex gap-4" justifyContent="space-between">
                            ...
                            <Link href="/register" passHref>
                                <Button variant="outlined" color="primary" className="my-2 w-40">
                                    Register
                                </Button>
                            </Link>
                        </Box>
            ...
            {/* Features Container */}<Container className="mt-10">
            ...
            <div className="grid mb-10 sm:grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="p-6 border bg-white bg-opacity-80 rounded-xl shadow-md text-center transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105">
                    ...
                    <Typography variant="body1" component="p" align="center">
                        Your transactions and data are protected with top-notch security.
                    </Typography>
                </div>
            </div>
        </Container>
