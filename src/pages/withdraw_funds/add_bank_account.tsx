...
const validationSchema = Yup.object({
    accountNumber: Yup.string().required('Required').matches(/^[0-9 ]{10}$/, 'Account number must be 10 digits'),
...
function AddBankAccount() {
    ...
    return (
        <Container className="flex flex-col gap-4">
            ...
            <Formik
                initialValues={{ accountNumber: '', bankName: '', beneficiaryName: '' }} // Add beneficiary initial value
                ...
                {({ errors, touched, setFieldValue }) => (
                    <Form>
                        <div className="flex flex-col gap-4">
                            ...
                            />
                            <Field name="bankName" as={TextField} label="Bank Name" fullWidth error={errors.bankName && touched.bankName} helperText={<ErrorMessage name="bankName" />}
                            />
                            <Field name="beneficiaryName" as={TextField} label="Beneficiary Name" fullWidth error={errors.beneficiaryName && touched.beneficiaryName} helperText={<ErrorMessage name="beneficiaryName" />} // Add beneficiary field
                            />
                        </div>
